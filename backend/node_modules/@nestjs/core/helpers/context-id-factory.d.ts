import { ContextId, HostComponentInfo } from '@nestjs/core/injector/instance-wrapper';
...
export interface ContextIdStrategy<T = any> {
     ...
     */
    attach(contextId: ContextId, request: T): ((info: HostComponentInfo) => ContextId) | undefined;
}
